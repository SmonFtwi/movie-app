...
const MovieDetail = () => {
  ...
  return (
    <div className="text-white bg-cover bg-center h-screen  bg-gray-950  bg-opacity-50" style={{backgroundImage: `url(https://image.tmdb.org/t/p/w500${movie.backdrop_path})`}}>
       <Header/>
      ...
      <h2 className=' text-3xl mt-20 font-bold '>{movie.title}</h2>
      </div>
